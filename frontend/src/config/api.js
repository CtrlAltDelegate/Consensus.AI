...
export const API_ENDPOINTS = {
  ...
  admin: {
    ...
    tokenValidation: '/api/admin/token-validation',
...
export const apiHelpers = {
  ...
  forgotPassword: (email) => api.post(API_ENDPOINTS.auth.forgotPassword, { email }),
  resetPassword: (token, newPassword) => api.post(API_ENDPOINTS.auth.resetPassword, { token, newPassword }),
  ...
  getAdminUsage: () => api.get(API_ENDPOINTS.admin.usage),
  getAdminTokenValidation: () => api.get(API_ENDPOINTS.admin.tokenValidation),
